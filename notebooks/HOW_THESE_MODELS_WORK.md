...
## Model 4: Using Regression Analysis for Continuous Target Prediction
You can find this model [here](https://github.com/karlidean/applied-ml-karlidean/blob/main/notebooks/project04/ml04_karlidean.ipynb)!
### Process
### Results

## Model 5: Ensemble (Bagging and AdaBoost Models)
You can find this model [here](https://github.com/karlidean/applied-ml-karlidean/blob/main/notebooks/project05/ensemble-karlidean.ipynb)!
### Process
### Results
