...
You can find this model [here](link)!\
- Utilized Jupyter Notebooks to predict prices of houses in the state of California.\
- Used visualization techniques in the Seaborn pack like boxplots, histograms, and pairplots.\
